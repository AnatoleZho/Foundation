...
//密匙 key
#define gkey            @"138dk839DEK28321138dkF83"
//偏移量
#define gIv             @"jukai"
...
//    NSString *originalStr = @"";
    NSError *error = nil;
        NSData *jsonData = [NSJSONSerialization dataWithJSONObject:originalDic options:0 error:&error];
//        originalStr = [[NSString alloc] initWithData:jsonData encoding:NSUTF8StringEncoding];
...
//    NSData* data = [originalStr dataUsingEncoding:NSUTF8StringEncoding];
    ...
    const void *vplainText = (const void *)[jsonData bytes];
...
-(NSDictionary*)doDecEncrypt:(NSDictionary *)encryptDic{
    ...
    NSString *encryptStr = [encryptDic objectForKey:@"P"];
    ...
    NSData *jsonDatas = [result dataUsingEncoding:NSUTF8StringEncoding];
    NSError *err;
    NSDictionary *dic = [NSJSONSerialization JSONObjectWithData:jsonDatas
